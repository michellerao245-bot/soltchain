...
const SnipingSignals = () => {
  ...
  const fetchAlphaSignals = useCallback(async () => {
    ...
    try {
      // 🔥 ENV + FALLBACK (IMPORTANT)
      const API =
        import.meta.env.VITE_API_URL ||
        "https://soltchain-backend.onrender.com/api";
      ...
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>
            Powered by SoltAI Engine • Live BSC Feed
          </p>
        </div>
        <div
          style={{
            ...styles.liveIndicator,
            color: fetching ? "#f59e0b" : "#22c55e",
          }}
        >
      ...
      <div style={styles.tableWrapper}>
        {error && (
          <div style={styles.error}>
            ⚠️ Backend Connection Lost. Check server.js
          </div>
        )}
                ...
                <tr key={pair.address} style={styles.row}>
                  ...
                  <td style={styles.td}>
                    <div
                      style={{
                        fontSize: "11px",
                        fontWeight: "bold",
                        color: pair.isRisky ? "#ef4444" : "#f59e0b",
                      }}
                    >
                      {pair.signal}
                    </div>
                  ...
                  <td style={styles.td}>
                    <button
                      ...
                      onClick={() =>
                        navigate(`/scanner?addr=${pair.address}`)
                      }
                    >
                      AUDIT
                    </button>
...
const styles = {
  ...
  liveIndicator: { fontSize: "10px", fontWeight: "bold" },
